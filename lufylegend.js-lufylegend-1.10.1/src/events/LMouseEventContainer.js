 ...
 * 		trace("onmouseOther object == event.currentTarget : " + (object == event.currentTarget), "");
 * 	}
 * @examplelink <p><a href="../../../api/LMouseEventContainer/2.html" target="_blank">Try it »</a></p>
 * @public
 */
/** @language japanese
 ...
 * 		trace("onmouseOther object == event.currentTarget : " + (object == event.currentTarget), "");
 * 	}
 * @examplelink <p><a href="../../../api/LMouseEventContainer/2.html" target="_blank">実際のサンプルを見る</a></p>
 * @public
 */
var LMouseEventContainer = (function () {
	...
	MouseEventContainer.prototype = {
		 ...
		 * 		addChild(bitmap);
		 * 	}
		 * @examplelink <p><a href="../../../api/LMouseEventContainer/2.html" target="_blank">测试链接</a></p>
		 * @public
		 * @since 1.8.5
		 */
		/** @language english
